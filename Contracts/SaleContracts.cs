...
public sealed record SaleReceiptResponse(Guid SaleId, DateTime CompletedAtUtc, IReadOnlyList<ReceiptItemResponse> Items);
public sealed record ReceiptItemResponse(string ProductId, int Quantity, IReadOnlyList<BatchAllocationResponse> BatchAllocations);
